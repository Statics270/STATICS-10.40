...
namespace ServerBotManager {
    ...
    AFortPlayerPawnAthena* SpawnBot(UFortServerBotManagerAthena* This, FVector SpawnLoc, FRotator SpawnRot, UFortAthenaAIBotCustomizationData* BotData)
    {
        ...
        if (!Backpacks.empty() && UKismetMathLibrary::GetDefaultObj()->RandomBoolWithWeight(0.5)) {
        ...
        // ENHANCED: Add dances to bot warmup inventory
        ...
        // ENHANCED: Initialize bot warmup timing
        Bot->NextEmoteTime = UGameplayStatics::GetDefaultObj()->GetTimeSeconds(UWorld::GetWorld()) + 
            UKismetMathLibrary::GetDefaultObj()->RandomFloatInRange(3.0f, 10.0f);
